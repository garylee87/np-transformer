...
train_data_vocabs = data_preparator.get_vocabs() #학습용 vocabs
...
class Seq2Seq():
    ...
    def forward(self, src, trg, training):                          # 전방전파
...
_, _, val_data = data_preparator.import_multi30k_dataset(path = "/home/gyeongseoplee/np-transformer/numpy-transformer/dataset/")
