...
class DataPreparator(): # data preparator
    ...
    def prepare_data(self, path = '/home/gyeongseoplee/np-transformer/numpy-transformer/dataset/', batch_size = 1, min_freq = 10): #배치사이즈
        
        train_data, val_data, test_data = self.import_multi30k_dataset(path)                      # multi30K 데이터셋을 불러와서 학습,검증,테스트 데이터로 전처리함
